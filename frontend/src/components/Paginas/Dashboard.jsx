                ...
                for (let i = 0; i < datos.length; i++) {
                    if (datos[i]["Categoria_Total"] != "Movimiento de Cuenta Común" &&
                        (datos[i]["Total_Cargos"] || datos[i]["Total_Abonos"] || datos[i]["Total_Saldo"]) ) {
                            if(datos[i]["Categoria_Total"] != null) {
                                    ...
                                    <div className="modal-dialog modal-xl" role="document">
                                        <div className="modal-content">
                                            ...
                                            <div className="modal-footer">
                                                <button type="button" className="btn btn-primary" data-bs-dismiss="modal" onClick={() => resetStateBG()}>OK</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="myModal1" className="modal fade">
                                    <div className="modal-dialog modal-xl" role="document">
                                        <div className="modal-content">
                                            ...
                                            <div className="modal-body">
                                                <section className ="flex-container">
                                                    <table className="table-responsive table-borderless" id="tablaER">
                                                        <thead>
                                                            <th scope="col"></th>
                                ...
                                <div id="myModal2" className="modal fade">
                                    <div className="modal-dialog modal-xl" role="document">
                                        <div className="modal-content">
                                            ...
                                            <div className="modal-body">
                                                <section className ="flex-container">
                                                    <table className="table-responsive table-borderless" id="tablaBC">
                                                        <thead>
                                                            <tr>
